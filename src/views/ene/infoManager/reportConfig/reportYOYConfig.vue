                    ...
                    <el-col :span="12">
                        <div style="float:right;padding-right:40px">
                            ...
                            <el-row style="padding-left:90px">
                                <el-button @click="cancel" style="position: relative;left:70px;">清 空</el-button>
                                <el-button
                                    type="primary"
    ...
    export default {
        ...
        methods: {
            ...
            upShare(data) {
                ...
                this.formData.id = data.id; //更行后跟formData绑定
                ...
                this.conditionList = [data.proccode];
                this.treeCheckbox = [data.proccode];
            },
            //删除设备
            delShare(id) {
            ...
            handleCheckChange(data, checked) {
                ...
                if (this.treeFirstLoad) {
                    if (checked) {
                        ...
                        if (
                            JSON.stringify(item) != JSON.stringify(this.formData.condition[0])
                        ) {
                            this.formData.condition.push(item);
                        }
                    } else {
