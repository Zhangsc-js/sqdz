<template>
  <el-tabs id="water" type="border-card" v-model="activeName">
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.schedulForm.costTime = simpleDateFormat(new Date(), "yyyy-MM-dd"); //天
...
<style lang='scss'>
#water .el-table::before {
  height: 0px;
}
#water .el-table__body-wrapper::-webkit-scrollbar {
  /*width: 0;宽度为0隐藏*/
  width: 0px;
}
#water .el-table__body-wrapper.is-scrolling-none {
  min-height: 200px;
  height: 59.5vh;
  overflow: auto;
...
.water .el-table__footer-wrapper {
  display: block !important;
  position: relative;
}
#water .el-tabs__content{
