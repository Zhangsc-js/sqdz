<template>
  <el-container style="padding-top:24px;height: 100%" class="inspection_comfirmed">
    <div style="width: 100%;">
      ...
      >
        <el-table-column prop="inspectionRecordNo" label="巡检单号" align="center" width="120"></el-table-column>
        <el-table-column prop="plan.planName" label="任务名称" align="center" width="150"></el-table-column>
        <el-table-column
          prop="executor"
        ...
        <el-table-column
          ...
          width="160"
        ></el-table-column>
        <el-table-column prop="status" label="巡检状态" align="center" width="120">
        ...
        <el-table-column prop="result" label="巡检结果" align="center" width="100">
          <template v-slot="scope">
        ...
        <el-table-column
          v-if="hasBtn([
            'DEV-OPS-INSPECTION-COMFIRMED-MODIFY',
            'DEV-OPS-INSPECTION-COMFIRMED-COMFIRM'
          ])"
          fixed="right"
          align="center"
          label="操作"
        ...
        >
          <template v-slot="scope">
            ...
            <el-button
              v-has="'DEV-OPS-INSPECTION-COMFIRMED-MODIFY'"
            ...
            >报修</el-button>
            <el-button
              v-has="'DEV-OPS-INSPECTION-COMFIRMED-COMFIRM'"
...
export default {
  ...
  methods: {
    ...
    detailsRecord(row) {
      ...
      this.inspectionRecordNo = row.inspectionRecordNo;
    },
    reportToOps(row) {
    ...
    saveModify() {
      updateInspectionRecord(this.selectRow)
        .then(response => {
          const result = response.data;
          if (result.success) {
...
<style lang="scss">
.inspection_comfirmed .el-form .el-col .el-button {
