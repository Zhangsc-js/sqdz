      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="执行人" prop="executor">
            <!-- <el-input v-model="updateForm.executor" :disabled="disabled"></el-input>-->
...
export default {
  ...
  methods: {
    ...
    getData(pageNum) {
      ...
      getLubricationPlanById(this.planId)
        .then(response => {
          const result = response.data;
          if (result.success) {
    ...
    getTableData(row) {
      ...
      getLubricationTempItems(params)
        .then(response => {
