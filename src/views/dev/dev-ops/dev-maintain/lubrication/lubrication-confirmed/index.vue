<template>
  <el-container style="padding-top:24px;height: 100%" class="lubrucation_confirmed">
    <div style="width: 100%;height: 100%">
      <el-form ref="queryForm" :model="queryForm" style="margin-left:20px" inline>
        <el-row>
          ...
          <el-form-item label="润滑计划" prop="planId">
        ...
        <el-row v-show="showMore">
          <el-form-item label="润滑状态" prop="status">
          ...
          <el-form-item label="润滑结果" prop="result">
      ...
      >
        <el-table-column prop="lubricationRecordNo" label="润滑单号" align="center" width="120"></el-table-column>
        ...
        <el-table-column
          ...
          width="160"
        ></el-table-column>
        <el-table-column prop="status" label="润滑状态" align="center" width="120">
        ...
        <el-table-column
          v-if="hasBtn([
            'DEV-OPS-LUBRICATION-COMFIRMED-MODIFY',
            'DEV-OPS-LUBRICATION-COMFIRMED-COMFIRM'
          ])"
          fixed="right"
          align="center"
          label="操作"
        ...
        >
          <template v-slot="scope">
            ...
            <el-button
              v-has="'DEV-OPS-LUBRICATION-COMFIRMED-MODIFY'"
            ...
            >变更</el-button>
            <el-button
              v-has="'DEV-OPS-INSPECTION-COMFIRMED-REPORT'"
            ...
            >报修</el-button>
            <el-button
              v-has="'DEV-OPS-LUBRICATION-COMFIRMED-COMFIRM'"
              v-if="scope.row.confirmed === 0 && scope.row.status"
              type="text"
              size="small"
              @click="confirmRecord(scope.row.id)"
            >确认</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="详情" :visible.sync="dialogVisible" width="65%">
      <record-item
        :recordNo="lubricationRecordNo"
        @hidenDialog="hidenDialog"
        style="height: 60vh;overflow: auto;"
      />
    </el-dialog>
    <el-dialog title="报修" :visible.sync="reportDialogVisible" width="65%">
      <repair-report
        :recordNo="lubricationRecordNo"
        @hidenDialog="hidenDialog"
        style="height: 60vh;overflow: auto;"
...
import {
  getLubricationRecords,
  updateLubricationRecord,
  getLubricationUserMap,
  updateRecord,
  getLubricationPlanMap
} from "@/api/device";

import { simpleDateFormat, isEmptyArray, isEmpty, hasBtn } from "@/utils/index";
...
export default {
  ...
  methods: {
    ...
    getPlanMap() {
      getLubricationPlanMap().then(res => {
    ...
    detailsRecord(row) {
      ...
      this.lubricationRecordNo = row.lubricationRecordNo;
    },
    reportToOps(row) {
...
<style lang="scss">
.lubrucation_confirmed .el-form .el-col .el-button {
