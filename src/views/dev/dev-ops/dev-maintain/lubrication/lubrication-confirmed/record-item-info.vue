  ...
  <div>
    <el-form ref="itemInfoForm" :model="itemInfoForm" label-width="200px">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="润滑部位(点):" prop="partsName">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="润滑方法:" prop="methodName">
            <span>{{ itemInfoForm.item.methodName }}</span>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="润滑油脂牌号:" prop="methodName">
            <span>{{ itemInfoForm.item.lubricationNo }}</span>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
