    ...
    <div style="display: flex">
        ...
        <div style="flex:3;height: 65vh; overflow: auto">
            <el-form ref="queryForm" :model="queryForm" label-width="80px">
                <el-row>
                    ...
                    <el-col :span="10" style="margin-left: 20px">
                        <el-button icon="el-icon-search" type="primary" class="btn-b" @click="getCheckingItemInfo(1)">查询
                        </el-button>
            ...
            <el-table
                ...
                <el-table-column prop="partsName" label="点检部位" align="center"></el-table-column>
                <el-table-column prop="projectName" label="点检内容" align="center"></el-table-column>
                <el-table-column prop="methodName" label="点检方法" align="center"></el-table-column>
                <el-table-column prop="criteriaName" label="点检标准" align="center"></el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            getCheckingItemInfo(pageNum) {
                ...
                getCheckingItemInfoByDevNo(params).then(response => {
            ...
            save() {
                ...
                addCheckingTempItem(this.selectItemIds).then(response => {
                    const result = response.data
                    if (result.success) {
