  ...
  <div style="width: 100%;">
    <el-form inline ref="queryForm" :model="queryForm">
      ...
      <el-row>
        <el-form-item>
          <el-button
            v-has="'DEV-OPS-MAINTAIN-PLAN-ADD'"
            type="primary"
    ...
    >
      ...
      <el-table-column
        v-if="hasBtn([
            'DEV-OPS-MAINTAIN-PLAN-ACTIVATE',
            'DEV-OPS-MAINTAIN-PLAN-UPDATE',
            'DEV-OPS-MAINTAIN-PLAN-DELETE',
            'DEV-OPS-MAINTAIN-PLAN-STOP'
          ])"
        align="center"
        label="操作"
        width="220px"
      >
        <template v-slot="scope">
          <el-button
            v-has="'DEV-OPS-MAINTAIN-PLAN-ACTIVATE'"
          ...
          <el-button
            v-has="'DEV-OPS-MAINTAIN-PLAN-UPDATE'"
          ...
          >更新</el-button>
          <el-button
            v-has="'DEV-OPS-MAINTAIN-PLAN-DELETE'"
            v-if="scope.row.status === 0"
            type="text"
            size="small"
          ...
          >删除</el-button>
          <el-button
            v-has="'DEV-OPS-MAINTAIN-PLAN-STOP'"
