<template>
  <div class="planAdd">
    <el-form :model="addForm" ref="addForm" label-width="120px" :rules="rules">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="周期" prop="frequently">
            <el-select multiple v-model="addForm.frequently" placeholder="请选择" style="width: 80%;">
              <el-option
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="计划开始时间" prop="startTime" style="width: 100%;">
            <el-date-picker
              id="startTime"
