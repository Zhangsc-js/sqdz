<template>
  <el-container style="padding-top:24px;height: 100%">
    <div style="width: 100%;">
      ...
      >
        <el-table-column prop="recordNo" label="保养单号" align="center" width="120"></el-table-column>
        ...
        <el-table-column
          ...
          width="180"
        ></el-table-column>
        <el-table-column prop="status" label="保养状态" align="center" width="100">
        ...
        <el-table-column
          v-if="hasBtn([
            'DEV-OPS-MAINTAIN-COMFIRMED-MODIFY',
        ...
        >
          <template v-slot="scope">
            ...
            <el-button
              v-has="'DEV-OPS-MAINTAIN-COMFIRMED-MODIFY'"
            ...
            >变更</el-button>
            <el-button
              v-has="'DEV-OPS-MAINTAIN-COMFIRMED-REPORT'"
            ...
            >报修</el-button>
            <el-button
              v-has="'DEV-OPS-MAINTAIN-COMFIRMED-COMFIRM'"
    ...
    <el-dialog title="详情" :visible.sync="dialogVisible" width="65%">
      <record-item :recordNo="recordNo" style="height: 60vh;overflow: auto;" />
    </el-dialog>
...
import { isEmptyArray, isEmpty, simpleDateFormat, hasBtn } from "@/utils/index";

export default {
  name: "MatintainConfirmed",
  components: {
    Pagination,
    RecordItem,
    JtBadge,
