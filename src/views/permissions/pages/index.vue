<template>
  <div>
    <div class="tableshadow margin20" style="height:calc(100% - 40px);">
      <div class="menu-panel">
          ...
          <div class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <span>
              <span v-if="!data.children||data.children.length==0">
                <el-button class="el-button--small" type="text">查看</el-button>
                <el-button
                  class="el-button--small"
                  type="text"
                  @click="handleCreate(null,1);setPid(3,pid)"
                >添加权限点</el-button>
                <el-button class="el-button--small" type="text">删除权限点</el-button>
              </span>
            </span>
          </div>
        </el-tree>-->
        <el-table
          ...
          default-expand-all
        >
          <el-table-column prop="meta.title" label="名称" width="180"></el-table-column>
          <el-table-column prop="" label="权限内容"></el-table-column>
    ...
    <div class="dashboard-container" style="padding-top:55px">
        ...
        <el-card shadow="never">
          ...
          <el-table :data="dataList" fit style="width: 100%;" highlight-current-row>
            <el-table-column fixed prop="name" label="菜单名称" width="200px">
              <template slot-scope="scope">
                <i
                  :class="scope.row.type==1?'ivu-icon fa fa-folder-open-o fa-fw':'ivu-icon  el-icon-view'"
                  :style="scope.row.type==1?'margin-left: 0px':'margin-left: 20px'"
                ></i>
...
import { saveOrUpdate, list, detail, remove } from "@/api/permissions";
