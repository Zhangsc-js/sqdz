                            ...
                            <div class="treeRinfo">
                              <el-dropdown class="item">
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    ...
                                    <el-dropdown-item>
                                      <el-button type="text" @click="handUpdate(data.id)">修改部门</el-button>
                                    </el-dropdown-item>
                                  <el-dropdown-item>
                                    <el-button type="text" @click="handleList()">查看待分配员工</el-button>
                                  </el-dropdown-item>
...
<script>
  ...
  /*  import {list,saveOrupdate,find,deleteById} from "@/api/base/dept"
    ...
    import {list, find, deleteById, update} from "@/api/dept"
    import deptAdd from './../components/add'
    import commonApi from '@/utils/common'
    export default {
        components:{deptAdd},
...
<style rel="stylesheet/scss" lang="scss">
    ...
    .dashboard-container .el-tree-node__content>.el-tree-node__expand-icon {
        padding:0px;
    }
    .dashboard-container .el-tree-node__expand-icon {
        color:#ffffff
    }
    .dashboard-container .generalClassNode {
        padding-left: 20px;
    }
    .dashboard-container .el-tree-node__content{
        font-size: 16px;
        line-height: 36px;
        height:36px;
    }
    .dashboard-container .custom-tree-node{
        padding-left: 20px;
    }
    .dashboard-container .objectTree {
        overflow: auto;
        z-index: 100;
        width: 300px;
    ...
    .dashboard-container .boxpad {
        margin-left: -40px;
    }
    .dashboard-container .el-button--mini{
        line-height: 32px;
    }
</style>
