<template>
  ...
  >
    <el-tab-pane label="车号分类" name="first">
      <el-form :inline="true" class="demo-form-inline" ref="inMeterTruckGbForm" >
        <!--<el-col :span="6">-->
          <el-form-item label="车号" prop="truckNo">
            <el-select
              v-model="inMeterTruckGbForm.truckNo"
        ...
        <el-col :span="6">-->
          <el-form-item label="日期" prop="truckNo">
            <el-date-picker
              v-model="inMeterTruckGbForm.createdOn"
              type="date"
              placeholder="选择日期"
      ...
      <div id="outTable">
        ...
        >
          ...
          <el-table-column prop="supplier" label="发货单位" align="center" width="180"></el-table-column>
    ...
    <el-tab-pane label="货物分类" name="second">
      <el-form :inline="true" class="demo-form-inline" ref="inMeterGoodsGbForm" >
        <!--<el-col :span="6">-->
          <el-form-item label="货物名称" prop="goodsName">
            <el-input
              id="goodsName"
              v-model="inMeterGoodsGbForm.goodsName"
              :maxlength="20"
              plain="true"
              placeholder="请输入货物名称"
              style="width: 200px"
        ...
        <el-col :span="6">-->
          <el-form-item label="日期" prop="truckNo">
            <el-date-picker
              v-model="inMeterGoodsGbForm.createdOn"
              type="date"
              placeholder="选择日期"
              value-format="yyyy-MM-dd"
              style="width:200px"
    ...
    <el-tab-pane label="发货单位分类" name="third">
      <el-form :inline="true" class="demo-form-inline" ref="inMeterSupplierGbForm" >
        <!--<el-col :span="6">-->
          <el-form-item label="发货单位" prop="supplier">
            <el-input
              id="supplier"
              v-model="inMeterSupplierGbForm.supplier"
              :maxlength="20"
              plain="true"
              placeholder="请输入发货单位"
              style="width: 200px"
        ...
        <el-col :span="6">-->
          <el-form-item label="日期" prop="truckNo">
            <el-date-picker
              v-model="inMeterSupplierGbForm.createdOn"
              type="date"
              placeholder="选择日期"
              value-format="yyyy-MM-dd"
              style="width:200px"
...
import {
  getInMeterGroupByTruckNo,
  getInMeterGroupByGoodsName,
  getInMeterGroupBySupplier
} from "@/api/weighing";
...
export default {
  ...
  methods: {
    ...
    getData() {
      getInMeterGroupByTruckNo(this.inMeterTruckGbForm).then(response => {
        this.tableData = response.data.data;
      });
      getInMeterGroupByGoodsName(this.inMeterGoodsGbForm).then(response => {
        this.tableDataOne = response.data.data;
      });
      getInMeterGroupBySupplier(this.inMeterSupplierGbForm).then(response => {
    ...
    clearSearchBox() {
      this.inMeterTruckGbForm = {
        truckNo: "",
        createdOn: ""
      };
      this.inMeterGoodsGbForm = {
        goodsName: "",
        createdOn: ""
      };
      this.inMeterSupplierGbForm = {
        supplier: "",
        createdOn: ""
      };
    },
