<template>
  <div>
    <el-form
      ...
      class="margin20 mb0"
    >
      <el-form-item label="审核拒绝时间" prop>
        <el-date-picker
      ...
      <el-form-item label="车间" prop="workShop">
        <el-input v-model="queryForm.workShop" plain="true" placeholder="请输入车间" />
      </el-form-item>
      ...
      <el-form-item label="收样地点" prop="receivePlace">
        <el-input v-model="queryForm.receivePlace" plain="true" placeholder="请输入收样地点" />
      </el-form-item>
      <el-form-item>
        <el-button
          icon="el-icon-search"
    ...
    <div class="tableshadow margin20" style="width:calc(100% - 40px);padding:20px 0;">
      <el-table :data="tableData">
        ...
        <el-table-column prop="labMain.proName" label="化验物料"></el-table-column>
        ...
        <el-table-column prop="reviewTime" width="180" label="审核拒绝时间"></el-table-column>
        <el-table-column
          label="操作"
          align="center"
          width="100"
          fixed="right"
          v-if="hasBtn(['LIMS-LAB-FAIL-INPUT'])"
        >
          <template v-slot="scope">
            <el-button
              type="text"
...
import { getLabFail } from "@/api/lims";
...
export default {
  ...
  methods: {
    ...
    getData(page) {
      ...
      getLabFail({ ...this.page, ...this.queryForm })
        .then(res => {
