<template>
    <div>
        ...
        <el-table :data="tableData">
            ...
            <el-table-column prop="sampTime" width="180" align="center" label="取样时间"></el-table-column>
...
<script>
    import {miss, labelSample, lostSample, completeSample, getMissCause} from '@/api/lims'
    ...
    export default {
        ...
        methods: {
            ...
            getData(pageNum) {
                ...
                miss(params, this.queryForm).then((res) => {
