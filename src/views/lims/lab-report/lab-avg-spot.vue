<template>
  <div>
    ...
    <el-table :data="tableData" ref="refTable" :cell-class-name="setColor">
      ...
      <el-table-column prop="workShop" align="center" label="取样车间" min-width="150px"></el-table-column>
      <el-table-column prop="sampPlace" align="center" label="取样地点" min-width="150px"></el-table-column>
