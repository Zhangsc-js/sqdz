<template>
  <div>
    <el-table :data="tableData" stripe border style="width: 100%;" height="100%">
      <el-table-column prop="recordNo" label="巡检单号"></el-table-column>
...
<script>
import { selectInsRecordGroupByCode } from '@/api/device'
...
export default {
  ...
  data() {
    return {
      ...
      currActiveName: "inspectionRecord"
    }
  },
  props: {
    activeName: {
  ...
  methods: {
    getData() {
      ...
      selectInsRecordGroupByCode(params).then(response => {
